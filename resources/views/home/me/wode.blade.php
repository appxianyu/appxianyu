	...
	<div class="">
		...
		<div class="my-info">
			<div class="my-info-background"></div>
			 ...
			 @if(Session::get('id'))
			<img class="my-avatar" src="/appindex/images/img/pic.jpg" alt="">
			<!-- <span class="name"><a href="/login" style="color:#fff"></a></span> -->
			<span class="name"><a href="/login" style="color:#fff">{{Session::get('username')}}</a></span>
			...
			<img class="my-avatar" src="/appindex/images/img/pic.jpg" alt="">
			<!-- <span class="name"><a href="/login" style="color:#fff"></a></span> -->
			<span class="name"><a href="/login" style="color:#fff">账号登录</a></span>
			<span class="my-vip" style="background:none">超级会员&nbsp;&nbsp;&nbsp;&nbsp;积分:5190&nbsp;&nbsp;</span>
			@endif
		...
		<div class="my-car-shortcut">
			<div class="layout-column b-line" style="padding:10px 0">
				<a class="col"  rel="test" href="wait.html">
							<span class="img-icon ">
								<img class="img-icon-home" src="/appindex/images/icon-home/me-1.png" />
							</span>
					<span class="img-icon-name">待付款</span>
				</a>
				<a class="col"  rel="test" href="wait.html">
							<span class="img-icon ">
								<img class="img-icon-home" src="/appindex/images/icon-home/me-2.png" />
							</span>
					<span class="img-icon-name">待收货</span>
				</a>
				<a class="col" href="wait.html" rel="test">
							<span class="img-icon ">
								<img class="img-icon-home" src="/appindex/images/icon-home/me-3.png" />
							</span>
		...
		<div>
			<div class="aui-list-cells">
				<a href="wallet.html" class="aui-list-cell">
					<div class="aui-list-cell-fl"><img src="/appindex/images/icon-home/me-4.png"></div>
					<div class="aui-list-cell-cn">我的钱包</div>
					<div class="aui-list-cell-fr">3999</div>
				</a>
				<a href="collect.html" class="aui-list-cell">
					<div class="aui-list-cell-fl"><img src="/appindex/images/icon-home/me-13.png"></div>
					<div class="aui-list-cell-cn">我的收藏</div>
					<div class="aui-list-cell-fr"></div>
				</a>
				<a href="adds.html" class="aui-list-cell">
					<div class="aui-list-cell-fl"><img src="/appindex/images/icon-home/me-6.png"></div>
					<div class="aui-list-cell-cn">地址管理</div>
					<div class="aui-list-cell-fr"></div>
				</a>
				<a href="footprint.html" class="aui-list-cell">
					<div class="aui-list-cell-fl"><img src="/appindex/images/icon-home/me-5.png"></div>
					<div class="aui-list-cell-cn">我的足迹</div>
					<div class="aui-list-cell-fr">8450</div>
				</a>
				<div class="devider b-line"></div>
				<a href="bank.html" class="aui-list-cell">
					<div class="aui-list-cell-fl"><img src="/appindex/images/icon-home/me-7.png"></div>
					<div class="aui-list-cell-cn">我的银行</div>
					<div class="aui-list-cell-fr"></div>
				</a>
				<a href="evaluate.html" class="aui-list-cell">
					<div class="aui-list-cell-fl"><img src="/appindex/images/icon-home/me-9.png"></div>
					<div class="aui-list-cell-cn">我的评价</div>
					<div class="aui-list-cell-fr"></div>
				</a>
				<div class="devider b-line"></div>
				<a href="/logout" class="aui-list-cell">
					<div class="aui-list-cell-fl"><img src="/appindex/images/icon-home/me-11.png"></div>
...
<div class="tab-bar tab-bottom">
	...
	<a class="tab-button active" href="/wode"><i class="tab-button-icon icon icon-my" ></i><span class="tab-button-txt">我的</span></a>
</div>
