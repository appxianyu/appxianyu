...
<footer class="footer t-line">
	<div class="aui-car-ear">
		...
		<div class=""><a href="car.html" class="aui-car-lli">立即购买</a></div>
	</div>

</footer>

<script src="js/page/js/jquery.min.js"></script>
<script src="js/page/js/swiper.min.js"></script>
<script src="js/page/js/jquery.lazyload.js"></script>
<script>
